...
**Members:** Sparsh Khandelwal (Backend & Math Lead), Dheeraj (UML & Architecture Lead), Adityaraj Singh (Frontend Lead), Vaibhav Goyal (QA Lead)
...
* **Grid of Contributions:**
  ...
  2. **Dheeraj (UML & System Architecture Lead):**
