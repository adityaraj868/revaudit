export const UML_DIAGRAMS = [
  {
    ...
    svgPath: '/revaudit/diagrams/01_sequence_oauth.svg',
    fallbackSvg: '/diagrams/01_sequence_oauth.svg',
...
@enduml`
  },
  {
    ...
    type: 'Sequence Diagram',
    svgPath: '/revaudit/diagrams/02_sequence_audit_request.svg',
    fallbackSvg: '/diagrams/02_sequence_audit_request.svg',
...
@enduml`
  },
  {
    ...
    type: 'Sequence Diagram',
    svgPath: '/revaudit/diagrams/03_sequence_github_fetch.svg',
    fallbackSvg: '/diagrams/03_sequence_github_fetch.svg',
...
@enduml`
  },
  {
    ...
    type: 'Sequence Diagram',
    svgPath: '/revaudit/diagrams/04_sequence_pandas_baseline.svg',
    fallbackSvg: '/diagrams/04_sequence_pandas_baseline.svg',
...
@enduml`
  },
  {
    ...
    type: 'Sequence Diagram',
    svgPath: '/revaudit/diagrams/05_sequence_pdf_export.svg',
    fallbackSvg: '/diagrams/05_sequence_pdf_export.svg',
...
@enduml`
  },
  {
    ...
    type: 'Class Diagram',
    svgPath: '/revaudit/diagrams/06_class_diagram.svg',
    fallbackSvg: '/diagrams/06_class_diagram.svg',
